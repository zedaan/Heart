...
const DropdownField = (props) => {
    ...
    return (
        <Form.Field>
            <label className="label">{label}</label>
            <Field name="options" component="select" placeholder="sadsa">
...
let Demo = (props) => {
    ...
    return (
        <Form onSubmit={props.onSubmit}>
            ...
            <Field component={DropdownField} autoComplete='options' label="Employee/Spouse" name="options" placeholder="Select"/>
