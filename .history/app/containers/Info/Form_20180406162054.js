...
let Demo = (props) => {
    ...
    return (
        <Form onSubmit={props.onSubmit}>
            <Field component={InputBox} type="email" autoComplete='firstName' label="First Name" name="firstName"  placeholder="First Name"/>

            <Field component={InputBox} type="text" autoComplete='lastName' label="Last Name" name="lastName" placeholder="last Name"/>

            <Field component={DropdownField} type="text" autoComplete='lastName' label="Last Name" name="lastName" placeholder="last Name"/>
