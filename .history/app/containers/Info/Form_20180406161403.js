...
let Demo = (props) => {
    ...
    return (
        <Form onSubmit={props.onSubmit}>
            <Field component={InputBox} type="text" autoComplete='firstName' label="First Name" name="firstname" val={demoInfo && demoInfo.demographics && demoInfo.demographics.patient && demoInfo.demographics.patient[0].mrn ? `${demoInfo.demographics.patient[0].mrn}` : ''} />
