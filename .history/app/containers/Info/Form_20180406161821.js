...
let Demo = (props) => {
    ...
    return (
        <Form onSubmit={props.onSubmit}>
            <Field component={InputBox} type="text" autoComplete='firstName' label="First Name" name="firstname" className="main-input" placeholder="First Name"/>
            <Field component={InputBox} type="text" autoComplete='firstName' label="First Name" name="firstname" className="main-input" placeholder="last Name"/>
