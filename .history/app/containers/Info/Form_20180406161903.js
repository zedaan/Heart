...
const InputBox = (props) => {
    ...
    return (
        <Form.Field>
            ...
            <input className="main-input" {...input} type={type} autoComplete={autoComplete} placeholder={placeholder} checked={checked} name={name} value={input.value} className={className} />
        </Form.Field>
...
let Demo = (props) => {
    ...
    return (
        <Form onSubmit={props.onSubmit}>
            ...
            <Field component={InputBox} type="text" autoComplete='firstName' label="Last Name" name="lastName" className="main-input" placeholder="last Name"/>
